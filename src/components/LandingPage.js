  ...
  <div className="landing">
      ...
      <div className="first-body">
        <div className="first-body-items">
          <div className="first-body-item">
            <div className="first-note-pic"></div>
            <div className="first-note">
              <h3>What we are doing...</h3>
              <div>
                Ofatri is partnering with several businesses that rewards you
                everytime you make transactions. Rewards range from - data
                top-up, airtime top-up, fuel top-up, transport fare, brand
                products, food and many more...
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="third-body">
        ...
        <div className="third-body-step">
          <div className="steps">
            ...
            <div className="step-headline">Search an Offer</div>
            <div className="step-description">
              After SignUp, Login and search for an Offer i.e Ofatri Watch Promo
            </div>
          </div>
        </div>
        ...
        <div className="third-body-step">
          <div className="steps">
            ...
            <div className="step-headline">Join the Offer</div>
            <div className="step-description">
        ...
        <div className="third-body-step">
          <div className="steps">
            ...
            <div className="step-headline">Get Rewarded</div>
            <div className="step-description">
              After making transaction, your reward token is used to reward you
            </div>
          </div>
        </div>

        <div className="third-body-text2">Its That Simple...</div>
      </div>
    </div>
          ...
          <div className="row">
              ...
              <div className="card bg-dark">
                ...
                <div className="card-footer">
                  <p className="text-white text-center">
                    Sign in to be welcomed into the family of consumers enjoying
                    rewards
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-4 sm-12">
              <div className="card bg-dark mt-2">
                ...
                <div className="card-footer">
                  <p className="text-white text-center">
                    Enter an Offer name and Join to reveal Reward Token
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 sm-12">
              <div className="card bg-dark mt-2">
                ...
                <div className="card-footer">
                  <p className="text-white text-center">
                    Maybe you dont want to Redeem the Rewards, you can set Goals
                    and your Rewards will accumulate to help you reach the Goals
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 sm-12">
              <div className="card bg-dark mt-2">
                ...
                <div className="card-footer">
                  <p className="text-white text-center">
                    See how close you are to achieving your Goals
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="fourth-body">
          ...
          <div className="fourth-body-text">
            <ul>
              ...
              <li>
                Willing to use Ofatri to Promote your product or Services Offer?
              </li>
              <li>
                Want to manage and plan Rewards and Goals for your Customers?
              </li>
            </ul>
            <div>Then get your business listed on Ofatri</div>
          </div>
          <div className="fourth-body-button">
            <button id="contact-ofatri">
            ...
            <div className="offers">
              <div>
                ...
                <p className="text-center text-white">
                  Ofatri assigns a human dedicated Reward and Goal Manager who
                  helps set up and manages every activity for you while you
              ...
              <div>
                ...
                <p className="text-center text-white">
                  Your manager helps contact customers when they Join your Offer
                  even before making transaction, a way to strengthen your brand
                </p>
              </div>
              <div>
                <h4>Social Media Integration</h4>
                <p className="text-center text-white">
                  Ofatri Integrates your social media so that your customers can
                  view more pictures or videos of your products; This is
                  optional
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-center text-white">
                  You can relate with Ofatri about what kinds of Rewards or
                  Goals best excite your Customers, and other matters
                </p>
              </div>

              <div>
                <h4>Seamless Outsource</h4>
                <p className="text-center text-white">
                  We understand you might be busy, Ofatri can help treat your
                  customers to their Goals. Be it- Fun Vacation, Photoshoot
                  session, Dinner etc, Just to make your Customer Happy
                </p>
              </div>
            </div>
          </div>
    ...
    <div className="sixth-body">
      <div className="sixth-body-items">
        <div className="sixth-body-contacts">
          <div className="sixth-body-address">
            <div>
              Head Office: Block ID Area 8 Opic Estate Agbara, Ogun State
            </div>
          </div>
          <br />
          <div className="sixth-body-socials">
            <div>
              <a href="https://www.instagram.com/ofatribiz">
                <i className="fa fa-instagram"></i>
              </a>
              &nbsp; &nbsp;<i className="fa fa-twitter"></i>&nbsp; &nbsp;
              <a href="https://wa.me/2348060456301?text=tell%20me%20more%20about%20ofatri">
          ...
          <div className="work-with">
            <a href="https://forms.gle/L7DiqXXGXSrhNPqVA">
              <div>
                <i className="fa fa-briefcase"></i>&nbsp;&nbsp;become Ofatri
                business manager
              </div>
            </a>
          </div>
      ...
      <div className="sixth-body-copy">
        <div>
          <i className="fa fa-copyright"></i>ofatri 2020
        </div>
      </div>
    </div>
  </div>
