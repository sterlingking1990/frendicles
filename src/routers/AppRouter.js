        ...
        <div>
            ...
            {authUser=>{
                if(authUser){
                    ...
                    else if (authUser.email === 'uche@gmail.com' || authUser.email === 'cakelegend@gmail.com' || authUser.email === 'emeka@gmail.com' || authUser.email === 'asabe@gmail.com' ){ //partner emails
                        return <Component4 />
                    }
                    else{
                        return <Component2 />
